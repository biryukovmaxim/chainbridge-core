...
// Source: ./chains/tvm/listener/event-handler.go
...
import (
	...
	listener "github.com/ChainSafe/chainbridge-core/chains/tvm/calls/events"
...
func (m *MockEventListener) FetchDeposits(ctx context.Context, contractAddress address.Address, startTime, endTime *time.Time) ([]listener.Deposit, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchDeposits", ctx, contractAddress, startTime, endTime)
	ret0, _ := ret[0].([]listener.Deposit)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FetchDeposits indicates an expected call of FetchDeposits.
func (mr *MockEventListenerMockRecorder) FetchDeposits(ctx, contractAddress, startTime, endTime interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchDeposits", reflect.TypeOf((*MockEventListener)(nil).FetchDeposits), ctx, contractAddress, startTime, endTime)
}
